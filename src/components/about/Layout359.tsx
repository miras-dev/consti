...
export function Layout359() {
  const integrationImg = useCmsImage('about.layout359.integration', 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=600&fit=crop');
  return (
      ...
      <div className="container">
        <div className="rb-12 mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h2 className="rb-5 mb-5 text-3xl font-bold md:mb-6 md:text-4xl lg:text-5xl">Money and career work together</h2>
        ...
        <div className="grid auto-cols-fr grid-cols-1 border border-border-primary md:grid-cols-2">
          <div className="flex items-center justify-center">
            <img src={integrationImg} className="w-full h-64 object-cover" alt="Integration" />
          </div>
          <div className="flex flex-col justify-center p-6 md:p-8 lg:p-12">
            <div>
              <p className="mb-2 text-sm font-semibold">Approach</p>
              <h3 className="mb-5 text-2xl font-bold leading-[1.2] md:mb-6 md:text-3xl lg:text-4xl">Holistic consulting for lasting results</h3>
